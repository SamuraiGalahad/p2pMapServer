...
import trotech.service.usecase.stability.NetworkPeerService
import trotech.dao.redis.PeersRepository
import trotech.dto.AnnounceInfo
import trotech.dto.MapInfo
import trotech.dto.PeerInfo
        ...
        routing {
            ...
            post("/login") {
                ...
                if (username == "admin" && password == "password") {
                    val token = JWT.create().withIssuer("ktor-app").withClaim("username", username).sign(Algorithm.HMAC256(
                        secret
                    ))
